...
# Custom CSS for dropdown size and spacing
st.markdown("""
    <style>
    /* Selectbox text size */
    div[data-baseweb="select"] > div {
        font-size: 14px !important;   /* font size chhota */
        min-height: 28px !important;  /* box height kam */
    }

    /* Options in dropdown list */
    div[role="listbox"] > div {
        font-size: 13px !important;   /* options ka font aur chhota */
        padding-top: 2px !important;  /* upar ka gap kam */
        padding-bottom: 2px !important; /* niche ka gap kam */
    }

    /* Label (Symptom 1,2,3...) bhi chhota karo */
    label[data-testid="stWidgetLabel"] p {
        font-size: 13px !important;
        margin-bottom: 0.2rem !important; /* label aur box ke beech gap kam */
    }
    </style>
""", unsafe_allow_html=True)
...
st.markdown("""
    <style>
    .navbar {
        background-color: #bd8c7d; /* Rose Gold */
        padding: 12px;
        text-align: center;
        font-size: 20px;
        font-weight: bold;
    ...
    .navbar a:hover {
        color: #d1bfa7; /* Soft Gold hover effect */
    }
    .main {

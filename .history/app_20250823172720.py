...
st.markdown("""
    <style>
    /* Selectbox ke label ka font */
    div[data-baseweb="select"] > div {
        font-size: 12px !important;  /* font chhota */
        color: black !important;     /* font black */
    }
    label {
...
# Pehle options ke list ke start me ek placeholder add karo
cols = st.columns(3)
symptom_options = ["-- Select a Symptom --"] + options  
...
for i in range(num_symptoms):
    with cols[i % 3]:
        ...
        # Agar user ne default "-- Select a Symptom --" chhoda hai to ignore kar do

...
# ---------- Custom CSS ----------
# Centered Title + Dropdown Styling
st.markdown(
    """
    <style>
    /* Title center */
    ...
    /* Dropdown selected (when closed) */
    div[data-baseweb="select"] > div {
        font-size: 12px !important;    /* smaller font */
        padding-top: 2px !important;   /* less spacing */
        padding-bottom: 2px !important;
        min-height: 28px !important;   /* compact height */
    ...
    ul[role="listbox"] li {
        ...
        padding-top: 2px !important;   /* compact spacing */
        padding-bottom: 2px !important;
        color: black !important;
    }

    /* Extra spacing control for inner spans */

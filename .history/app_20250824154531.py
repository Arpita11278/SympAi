...
st.markdown("""
    <style>
    /* Selectbox ka outer box */
    div[data-baseweb="select"] {
        min-height: 28px;   /* box ki height kam */
        max-height: 28px;   /* fix height */
        width: 200px;       /* box ki width fix (default ~300px hoti hai) */
    }
    ...
    div[data-baseweb="select"] > div {
        ...
        padding: 2px 6px !important;  /* text padding kam */
    }

    /* Dropdown khulte time options ka size */
    ul[role="listbox"] li {
        font-size: 12px !important;
